This Python script computes all BRDF distances using Optimal Transport and Energy distances, for a single set of parameters.
...
Display correlation results in the console, and appends distances to a file ./Mosvalidation.csv